...
/**
 *   	\file       class/Swisspaymentssoc_page.php
...
dol_include_once('/module/class/swisspaymentssoc.class.php');
...
$object=new Swisspaymentssoc($db);
...
if ($action == 'list' || empty($id))
{
    ...
    $sql.= " FROM ".MAIN_DB_PREFIX."swisspayments_soc as t";
