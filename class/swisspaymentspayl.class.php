...
/**
 *  \file       class/swisspaymentspayl.class.php
 ...
 */
class Swisspaymentspayl extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='swisspaymentspayl';			//!< Id that identify managed objects
    ...
    function create($user, $notrigger=0)
    {
        ...
        if (isset($this->fk_payementfourn)) $this->fk_factid=trim($this->fk_payementfourn);
        if (isset($this->fk_payh)) $this->fk_payh=trim($this->fk_payh);
    ...
    function update($user, $notrigger=0)
    {
		...
		if (isset($this->fk_payementfourn)) $this->fk_payementfourn=trim($this->fk_payementfourn);
		if (isset($this->fk_payh)) $this->fk_payh=trim($this->fk_payh);
