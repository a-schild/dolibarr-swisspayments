...
Every module table carries an `entity` column, so the module's data is isolated per
company on a multi-entity Dolibarr install. See [`TODO.md`](TODO.md) for any remaining
known issues.
